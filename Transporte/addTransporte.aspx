...
<body>
 ...
 <div class="container my-5">   
     ...
     <asp:Button id="enviarcond" runat="server" Text="Enviar" OnClick="enviarcond_Click" />
    ...
    <button type="submit" class="btn btn-secondary" id="enviarVehiculo" runat="server">Enviar</button>
   </div>
    </div>      
</div>
</form>
